...
- [Array(2) Change elements](#array2-change-elements)
- [Array(3) Check elements](#array3-check-elements)
- [Array(4) Delete elements](#array4-delete-elements)
- [Array(5) Instantiation](#array5-instantiation)
- [Array(6) Iterate elements](#array6-iterate-elements)
- [Array(7) Reference elements](#array7-reference-elements)
- [Dir(1) Class methods](#dir1-class-methods)
- [Dir(2) Instance methods](#dir2-instance-methods)
- [File(1) Class methods](#file1-class-methods)
- [File(2) Instance methods](#file2-instance-methods)
- [Hash(1) Data change](#hash1-data-change)
- [Hash(2) Inspection](#hash2-inspection)
- [Hash(3) Instantiation](#hash3-instantiation)
...
- [String(4) Encoding](#string4-encoding)
- [String(5) Iterate string](#string5-iterate-string)
- [String(6) Reference string](#string6-reference-string)
- [String(7) Replace string](#string7-replace-string)
- [String(8) Search string](#string8-search-string)
